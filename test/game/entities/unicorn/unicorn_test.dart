...
import 'package:mission_launch/game/entities/unicorn/behaviors/behaviors.dart';
...
class _MissionLaunch extends MissionLaunch {
  _MissionLaunch({
    required super.l10n,
...
void main() {
  ...
  group('Unicorn', () {
    ...
    _MissionLaunch createFlameGame() {
      return _MissionLaunch(
        l10n: l10n,
